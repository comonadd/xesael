...
bool execute(struct ByteCode const* bc)
{
  ...
  static void* jmp_tbl[IOP_COUNT] = {
    ...
    &&IOP_JMPR_L,   &&IOP_JMPRC_L,   &&IOP_JMPRCI_L, &&IOP_JMPA_L,
    &&IOP_JMPAC_L,  &&IOP_JMPACI_L,  &&IOP_CALL_L,   &&IOP_RET_L,

    &&IOP_UNOP,     &&IOP_UNOP,      &&IOP_UNOP,     &&IOP_UNOP,
    &&IOP_UNOP,     &&IOP_UNOP,

    &&IOP_BINOP,    &&IOP_BINOP,     &&IOP_BINOP,    &&IOP_BINOP,
    &&IOP_BINOP,    &&IOP_BINOP,     &&IOP_BINOP,    &&IOP_BINOP,
    &&IOP_BINOP,    &&IOP_BINOP,     &&IOP_BINOP,
