...
static struct BSTNode* bst_node_new(void* key, void* val)
{
...
static NoRet bst_node_delete(struct BST* bst, struct BSTNode* node)
{
...
struct BSTNode* bst_insert_or_get(struct BST* bst,
                                  void* key,
                                  void* val,
                                  bool* exists)
{
...
bool bst_insert(struct BST* bst, void* key, void* val)
{
  bool exists = false;
...
bool bst_remove(struct BST* bst, void* key)
{
...
void* bst_find(struct BST const* bst, void const* key)
{
...
static NoRet bst_node_apply(struct BSTNode* node,
...
NoRet bst_apply(struct BST* bst, NoRet (*f)(struct BSTNode* node))
{
