...
enum ObjectBinOpType {
    /* Arithmetic */
    O_BINOP_ADD, O_BINOP_SUB, O_BINOP_MUL, O_BINOP_DIV,
    O_BINOP_MOD, O_BINOP_POW,
    O_BINOP_BAND, O_BINOP_BOR,
    O_BINOP_BXOR,
    O_BINOP_LS, O_BINOP_RS,

    /* Boolean */
    O_BINOP_LAND, O_BINOP_LOR,

    /* Comparison */
    O_BINOP_EQ, O_BINOP_NEQ,
    O_BINOP_LT, O_BINOP_GT,
    O_BINOP_LTE, O_BINOP_GTE
};
