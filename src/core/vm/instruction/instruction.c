...
char const* INSTR_CODE_STR[IOP_COUNT] = {
  ...
  "JMPR",   "JMPRC",   "JMPRCI", "JMPA", "JMPAC", "JMPACI", "CALL", "RET",

  "NEG",    "NOT",     "BNOT",   "LEN",  "INCR",  "DECR",

  "ADD",    "SUB",     "MUL",    "DIV",  "MOD",   "POW",    "BAND", "BOR",
  "BXOR",   "LS",      "RS",
...
Instruction instr_load_new(const ImmediateID immediate_id, const RegisterID rid)
{
...
Instruction instr_jmpac_new(const InstructionPosition pos, const RegisterID rid)
{
